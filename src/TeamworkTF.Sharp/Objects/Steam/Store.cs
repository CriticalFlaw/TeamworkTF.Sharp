...
namespace TeamworkTF.Sharp
{
    ...
    public class Data
    {
        ...
        public CarouselData CarouselData { get; set; }
        ...
        public List<PlayerClassData> PlayerClassData { get; set; }
    ...
    public class Filter
    {
        ...
        public AllElement AllElement { get; set; }
    ...
    public class Sorting
    {
        ...
        public List<SortingPrefab> SortingPrefabs { get; set; }
    }
    ...
    public class SortingPrefab
    {
        ...
        public List<SorterId> SorterIds { get; set; }
    }
